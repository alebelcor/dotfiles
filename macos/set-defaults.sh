...
# Start BitBar at login
defaults write com.matryer.BitBar StartAtLogin -bool true

# Create plugin folder if it doesn't exist
if test ! -d "${HOME}/bitbar-plugins"
then
	mkdir "${HOME}/bitbar-plugins"
fi
...
# Start Caffeine at login
defaults write com.lightheadsw.Caffeine StartAtLogin -bool true
...
# Start Google Chrome at login
defaults write com.google.Chrome StartAtLogin -bool true

# ==========================================================================
# Lightshot Screenshot
# ==========================================================================

# Start Lightshot at login
defaults write com.skillbrains.lightshot StartAtLogin -bool true
